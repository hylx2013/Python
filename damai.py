...
URL = "https://piao.damai.cn/173942.html?pos=1&acm=201808136-1.1003.2.5155533&scm=1003.2.201808136-1.OTHER_1549563993180_5155533?spm=a2oeg.home.banner.ditem_0.591b23e1HHB5nv&clicktitle=%E4%B8%8A%E6%B5%B7%E5%BC%A0%E6%9D%B0"# PC页面

#URL = 'http://m.damai.cn/damai/perform/item.html?projectId=146290'#手机页面
# HOUR = 19
MIN  = 0
USERNAME = "18684804573"
...
def login():
    ...
    login.click()
    username = chooseIframe('//*[@id="fm-login-id"]')
    ...
    （也可用cookie实现）
    """
    password = chooseIframe('//*[@id="fm-login-password"]')
    try:
        password.click()
        password.send_keys("miaomiao0929")
    except Exception:
        print(password)
